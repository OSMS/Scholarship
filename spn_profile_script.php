	  ...
	  echo "
	  	<div id='info'>
	  		<span class='col-md-12' style='border-bottom: 1px solid #CCC;float:left;padding-bottom: 10px;'>
				<img src='data:image/jpeg;base64,".base64_encode($img)."' style='height: 150px;width: 150px;border: 1px solid #2FA4E7;float: left;'/>									<h1 style='color: black;margin-left: 20px;float:left;padding-top: 80px;'>{$row['name']} </h1>
